...
Т.к. распределения раундов имеют визуально нормальный вид и большой объём, то мы можем использовать для проверки на значимость расхождения в продолжительности Т-тест Стьюдента. Она не имеет ограничений по соотношению объёмов выборки, а дисперсия наших выборок одного порядка.
